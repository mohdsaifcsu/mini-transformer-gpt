# bpe_tokenizer.py  (GPT-2 BPE Tokenizer for MINI model)
...
class GPT2BPETokenizer:
    ...
    def __init__(self, vocab_file: str, merges_file: str):
        ...
        # vocabulary size used by GPT-2 models
    ...
    def encode(self, text: str) -> List[int]:
        ...
        for token in tokens:
            ...
            for bt in bpe_token.split(" "):
                bpe_tokens.append(
                    self.encoder.get(bt, self.encoder[self.unk_token])
                )
